    ...
    return (
        <div className="pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32" >
            <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    {filteredRooms.map((room) => (
                        <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                            <img onClick={() => { navigate(`/rooms/${room._id}`); scrollTo(0, 0) }}
                                ...
                                className='max-h-65 md:w-1/2 rounded-xl shadow-xl shadow-lg object-cover
                cursor-pointer'/>
                ...
                {/* Filters */}
                <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16 self-start'>
